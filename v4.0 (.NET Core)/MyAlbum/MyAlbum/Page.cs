...
namespace MyAlbum
{
    class Page : Container
    {
        ...
        public override void Calculate()
        {
            ...
            {
                case "portrait":
                    _pdfPage.Orientation = PdfSharpCore.PageOrientation.Portrait;
                    break;
                case "landscape":
                    _pdfPage.Orientation = PdfSharpCore.PageOrientation.Landscape;
                    break;
                default:
                    _pdfPage.Orientation = PdfSharpCore.PageOrientation.Portrait;
                    break;
            ...
            {
                case "letter":
                    _pdfPage.Size = PdfSharpCore.PageSize.Letter;
                    break;
                case "a4":
                    _pdfPage.Size = PdfSharpCore.PageSize.A4;
                    break;
                default:
                    _pdfPage.Size = PdfSharpCore.PageSize.Letter;
                    break;
            ...
            #region page canvas
                if (_pdfPage.Orientation == PdfSharpCore.PageOrientation.Portrait)
                {
                    x = MarginLeft;
                    y = MarginTop;
