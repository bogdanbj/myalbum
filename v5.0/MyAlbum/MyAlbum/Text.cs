...
namespace MyAlbum
{
    class Text : BaseElement
    {
        ...
        public XFontStyleEx FontStyle { get; set; }
        ...
        private void ParseFontStyleAttribute()
        {
            if (Xml.Attribute("font_style") != null)
            {
                ...
                {
                    case "bold":
                        this.FontStyle = XFontStyleEx.Bold;
                        break;
                    case "bolditalic":
                        this.FontStyle = XFontStyleEx.BoldItalic;
                        break;
                    case "italic":
                        this.FontStyle = XFontStyleEx.Italic;
                        break;
                    case "regular":
                        this.FontStyle = XFontStyleEx.Regular;
                        break;
                    case "strikeout":
                        this.FontStyle = XFontStyleEx.Strikeout;
                        break;
                    case "underline":
                        this.FontStyle = XFontStyleEx.Underline;
                        break;
                    default:
                        this.FontStyle = XFontStyleEx.Regular;
                        break;
